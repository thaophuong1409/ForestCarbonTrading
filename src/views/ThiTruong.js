...
const ThiTruong = (props) => {

    return (
        <div style={{backgroundColor: "#DCE19D"}}>
            <TopNav />
            <section className='row g-0'> 
                <img alt="" src="/images/8.png" style={{ width: "100%", height: "80%" }} align="right"/>
            </section>
            <section className="row g-0">
                ...
                <div className="col-md-5 mt-5">
                    ...
                    <p>Chúng tôi là điểm đến đáng tin cậy cho các doanh nghiệp, tổ chức, nhà đầu tư và cộng đồng quan tâm đến việc giảm khí thải và bảo vệ môi trường.</p>
                </div>
